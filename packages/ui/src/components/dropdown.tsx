  ...
  return (
    <DropdownPortal>
      ...
      >
        <Menu.Popup
          className={cn(
            "flex max-h-[var(--available-height)] min-w-40 flex-col gap-0.5 overflow-y-auto overflow-x-hidden rounded-3xl border-2 border-border bg-popover p-1 text-popover-foreground shadow-md [--dropdown-content-padding:calc(var(--spacing)*1)] [--dropdown-content-radius:var(--radius-3xl)] [scrollbar-color:gray_transparent] [scrollbar-width:thin] [&>[data-slot=dropdown-group]:first-child>[data-slot=dropdown-item]:first-child]:rounded-t-[calc(var(--dropdown-content-radius)-var(--dropdown-content-padding))] [&>[data-slot=dropdown-group]:last-child>[data-slot=dropdown-item]:last-child]:rounded-b-[calc(var(--dropdown-content-radius)-var(--dropdown-content-padding))] [&>[data-slot=dropdown-item]:first-child]:rounded-t-[calc(var(--dropdown-content-radius)-var(--dropdown-content-padding))] [&>[data-slot=dropdown-item]:last-child]:rounded-b-[calc(var(--dropdown-content-radius)-var(--dropdown-content-padding))]",
            className
          )}
