	...
	return (
		<MotionConfig reducedMotion="user">
			<motion.div
				...
				className={cn(
					"group relative flex h-10 w-9 items-center justify-center rounded-[10px] border border-border bg-background font-medium text-base text-foreground",
				...
				<AnimatePresence mode="wait">
					{isActive && (
						<motion.div
							...
							className="absolute inset-0 z-10 rounded-[inherit] ring-2 ring-primary"
...
function FakeCaret() {
	return (
		...
		>
			<div className="h-4.5 w-px bg-foreground motion-safe:animate-caret-blink motion-safe:duration-1000" />
		</div>
	);
}
