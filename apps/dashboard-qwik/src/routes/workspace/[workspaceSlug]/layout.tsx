...
export const onRequest: RequestHandler = async ({ next, params, cookie, redirect, sharedMap }) => {
    ...
    if (!isMember || !member || !workspace) {
        throw redirect(302, "/auth/login?message=not%20a%20member%20of%20this%20workspace");
    }
