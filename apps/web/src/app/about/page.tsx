    ...
    return (
        <main className="min-h-screen flex flex-col space-y-16 text-black md:w-[450px] lg:w-[500px]">
            ...
            <div className="space-y-3">
                ...
                <FadeIn variant={3}>
                    <p>We are starting with using <Link href={"https://resend.com/"} className="underline">Resend</Link> to send emails and <Link href="https://cloudflare.com">Cloudflare</Link> to receive the emails with the email workers. We have now switched to a smtp server which is called <Link href="https://postalserver.io">Postal Server</Link>. This gives us the ability to allow custom domains and more features.</p>
                </FadeIn>
            </div>
        </main>
    );
