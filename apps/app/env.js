 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.app.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.app'; // ios bundle id
const PACKAGE = 'com.app'; // android package name
