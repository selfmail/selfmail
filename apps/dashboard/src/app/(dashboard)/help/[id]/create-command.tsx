...
export default function CreateCommentForm(): JSX.Element {
    ...
    return (
        <form className="flex flex-col" action={async (e: FormData) => {
            setError(undefined)
            ...
            <textarea className="border-2 mt-2 border-[#dddddddd] p-2 rounded-xl bg-[#f4f4f4] focus-visible:outline-none focus-visible:border-[#666666]" placeholder="Content" />
            <div>
                <Button type="submit">
                    Submit
                </Button>
