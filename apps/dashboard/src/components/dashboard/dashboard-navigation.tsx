...
const buildLinks = [
	{ href: "/workflows", label: m["dashboard.navigation.ai"] },
	{ href: "/workflows", label: m["dashboard.navigation.workflows"] },
	{ href: "/dev", label: m["dashboard.navigation.developers"] },
] as const;
const workspaceLinks = [
	{ href: "/contacts", label: m["dashboard.navigation.contacts"] },
	{ href: "/conversations", label: m["dashboard.navigation.conversations"] },
...
function NavColumn({
	...
	return (
		...
		>
			<div
				className={cn(
					"@2xl/dashboard-shell:flex hidden min-w-0 flex-col gap-3",
					compactAtTwoColumns &&
			...
			<AccordionPrimitive.Root
				className={cn(
					"flex min-w-0 flex-col @2xl/dashboard-shell:hidden",
					compactAtTwoColumns &&
...
export function DashboardNavigation({
	...
	return (
		<nav className="grid w-full min-w-0 grid-cols-1 items-start gap-4 @2xl/dashboard-shell:grid-cols-[repeat(2,minmax(0,max-content))] @2xl/dashboard-shell:justify-between @2xl/dashboard-shell:gap-8 @min-[68rem]/dashboard-shell:grid-cols-[repeat(3,minmax(0,max-content))]">
			<SettingsDialog
				memberId={memberId}
