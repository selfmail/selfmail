...
import { UpgradeSettingsPage } from "../upgrade";
...
export const settingsPages: SettingsPage[] = [
	...
	{
		component: UpgradeSettingsPage,
		description: m["dashboard.settings.menu.upgrade.description"],
		icon: CreditCardIcon,
		id: "upgrade",
		title: m["dashboard.settings.menu.upgrade.title"],
	},
	{
