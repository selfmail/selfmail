...
export default function SlashMenu() {
  ...
  return (
    <AutocompletePopover regex={/\/.*$/iu} className='relative block text-white max-h-[400px] min-w-[120px] select-none overflow-auto whitespace-nowrap p-1 z-10 box-border rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-neutral-900 shadow-lg [&:not([data-state])]:hidden'>
      <AutocompleteList>
