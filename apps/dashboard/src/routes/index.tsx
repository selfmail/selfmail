...
export const head: DocumentHead = ({ resolveValue }) => {
  const workspaces = resolveValue(useWorkspaces);
  const workspaceCount = workspaces.length;

  return {
    title: "Dashboard - Choose Workspace | Selfmail",
    meta: [
      {
        name: "description",
        content: `Select from your ${workspaceCount} workspace${workspaceCount !== 1 ? "s" : ""} or create a new one to manage your emails on Selfmail.`,
      },
      {
        property: "og:title",
        content: "Dashboard - Choose Workspace | Selfmail",
      },
      {
