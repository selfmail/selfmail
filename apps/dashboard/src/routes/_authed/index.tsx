...
function RouteComponent() {
  ...
  return (
    <main className="flex min-h-dvh w-full flex-col items-center justify-center gap-y-3 bg-white px-5 py-10 text-neutral-950">
      <h1 className="text-balance font-medium text-lg">Pick your Workspace</h1>
      <div className="flex w-full flex-col gap-6 rounded-lg border border-neutral-200 bg-white p-5 lg:max-w-md">
        {workspaces.length === 0 ? (
...
function WorkspaceTile({ workspace }: { workspace: DashboardWorkspace }) {
  return (
    <Link
      className="flex items-center gap-x-3 rounded-lg border border-neutral-200 p-3 hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-300"
      params={{
